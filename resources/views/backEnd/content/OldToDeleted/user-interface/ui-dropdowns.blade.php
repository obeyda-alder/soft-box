...
@section('content')
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    ...
                    <div class="demo-inline-spacing">
                        <div class="btn-group" id="dropdown-icon-demo">
                            <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                                aria-expanded="false"><i class="bx bx-menu"></i> With Icon</button>
                            <ul class="dropdown-menu">
    ...
    <div class="card" id="dropdown-variation-demo">
        ...
        <div class="card-body">
            ...
            <div class="demo-inline-spacing">
                <div class="btn-group">
                    <button class="btn btn-primary btn-xl dropdown-toggle" type="button" data-bs-toggle="dropdown"
        ...
        <div class="card-body">
            <div class="row gy-3">
                <!-- Dropdown options -->
                <div class="col-xl-6">
                    <small class="text-light fw-semibold">Options : Use <code>data-bs-offset</code> or
