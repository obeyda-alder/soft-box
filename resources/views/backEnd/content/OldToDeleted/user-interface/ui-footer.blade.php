            ...
            <div
                ...
                <div>
                    <a href="{{ config('variables.livePreview') }}" target="_blank"
                        class="footer-text fw-bolder">{{ config('variables.templateName') }}</a> ©
                </div>
                <div>
        ...
        <footer class="footer bg-light">
            <div
                ...
                <div>
                    ...
                    <a href="javascript:void(0)" class="btn btn-sm btn-outline-danger"><i class='bx bx-log-out-circle'></i>
                        Logout</a>
                </div>
            </div>
        </footer>
