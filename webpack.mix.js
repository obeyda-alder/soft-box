...
mixAssetsDir('frontEnd/js/**/*.js', (src, dest) => mix.scripts(src, dest));
mixAssetsDir('frontEnd/webfonts/**/*', (src, dest) => mix.copy(src, dest));
mixAssetsDir('frontEnd/css/**/*.css', (src, dest) => mix.copy(src, dest));
